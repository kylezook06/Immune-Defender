...
2. Use `←` / `→` to move and hold **Space** to stream shots (faster during an antibody boost). On touchscreens, tap to start/restart, drag to steer the cell, and keep your finger down to fire.
